        ...
        <div className={style.footer_content}>
          <div className={style.contacts}>
            ...
            <div className={style.social_media}>
              <a href="https://www.instagram.com" target='_blank' className={style.social_link} id="Instagram">
                <FaInstagram size={40} />
              </a>
              <a href="https://www.facebook.com" target='_blank' className={style.social_link} id="Facebook">
                <FaFacebook size={40} />
              </a>
              <a href="https://www.linkedin.com/feed/" target='_blank'className={style.social_link} id="Linkedin">
                <FaLinkedin size={40} />
              </a>
            </div>
          </div>
          <ul className={style.list}>
            ...
            <li>
              <a href="https://www.whatsapp.com" target='_blank' className={style.sobre_link}>
